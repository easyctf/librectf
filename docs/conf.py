...
sys.path.insert(0, os.path.abspath('/vagrant/server'))
...
project = u'OpenCTF'
copyright = u'2016, EasyCTF Team'
author = u'EasyCTF Team'
...
man_pages = [
    (master_doc, 'OpenCTF', u'OpenCTF Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OpenCTF', u'OpenCTF Documentation',
     author, 'EasyCTF Team', 'A CTF in a box.',
     'Miscellaneous'),
]
