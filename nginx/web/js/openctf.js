...
app.config(function ($routeProvider, $locationProvider) {
    $routeProvider.when("/", {
        ...
        .when("/help", {
            ...
            resolve: {
                "result": function () {
                    return resolve_api_call("GET", "/api/tickets/data", {});
                }
            }
        })
        .when("/help/:ticket", {
            ...
            resolve: {
                "result": function ($route) {
                    return resolve_api_call("GET", "/api/tickets/data", {"htid": $route.current.params.ticket});
                }
            }
        })
        .when("/learn", {
        ...
        .when("/profile", {
            ...
            resolve: {
                "result": function () {
                    return resolve_api_call("GET", "/api/user/info", {});
                }
            }
        })
        .when("/profile/:username", {
            ...
            resolve: {
                "result": function ($route) {
                    return resolve_api_call("GET", "/api/user/info", {"username": $route.current.params.username});
                }
            }
        })
        .when("/programming", {
            ...
            resolve: {
                "result": function () {
                    return resolve_api_call("GET", "/api/programming/problems", {});
                }
            }
        })
        .when("/register", {
        ...
        .when("/setup", {
            ...
            resolve: {
                "result": function () {
                    return resolve_api_call("GET", "/api/admin/setup/init", {});
                }
            }
        })
        .when("/forgot", {
